...
@section('content')
  <div class="front">
    <div class="introductions">
      ...
      <p>Hello everyone! I'm PhantasmaAsaka, and I'm both a small Twitch streamer and a small-streamer supporter!</p>
      ...
      <p>Note: Counted views need to have the videos unmuted. I minimized the volume for you guys already! However, if you want to mute the sounds, just mute the tab by right-clicking on it! Also, make sure that this website is on a separate window!</p>
